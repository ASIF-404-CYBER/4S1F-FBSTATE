            ...
            fr.onload = function (evt) {
                try {
                    ...
                    if (encrypted === "base64") {
                        ...
                        // Asking for key
                        const pwdKey = prompt("PLEASE ENTER YOUR ENCRYPT KEY:");
                    ...
                    toastNotification("FAILD TO LOAD JSON FILE (MALFORMED?)");
                }
            }
        }
    }
    ...
    function exportFunc(encrypted) {
        chrome.cookies.getAll({
            ...
            if (encrypted === "base64") {
                ...
                // Asking for key
                let pwdKey = prompt("PLEASE ENTER ENCRYPT KEY:");
            ...
            btnDownload.onclick = function () {
                ...
                a.click();
                toastNotification('SUCCESSFULLY FBSTATE WAS DOWNLOADED!!' + a.download);
                a.remove();
            };
        });
    }
